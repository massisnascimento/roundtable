...
```{r}
Table_1 <- read_csv("../hits_tables/Table_1.csv") #Table 1 corresponds to known genes
Table_2 <- read_csv("../hits_tables/Table_2.csv") #Table 2 corresponds to new genes/loci discovered in the study
